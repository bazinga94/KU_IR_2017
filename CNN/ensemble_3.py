...
# Eval Parameters
tf.flags.DEFINE_integer("batch_size3",64, "Batch Size (default: 64)")
tf.flags.DEFINE_string("checkpoint_dir3", "ensemble/345/checkpoints", "Checkpoint directory from training run")
tf.flags.DEFINE_boolean("eval_train3", False, "Evaluate on all training data")

# Misc Parameters
tf.flags.DEFINE_boolean("allow_soft_placement3", True, "Allow device soft device placement")
tf.flags.DEFINE_boolean("log_device_placement3", False, "Log placement of ops on devices")
...
# Map data into vocabulary
    ...
    with graph2.as_default():
        ...
        # Generate batches for one epoch
            batches2 = data_helpers2.batch_iter(list(x_test2), FLAGS.batch_size3, 1, shuffle=False)
         #   print("batches_done")
