...
tf.flags.DEFINE_string("checkpoint_dir", "ensemble/456/checkpoints", "Checkpoint directory from training run")
...
# Map data into vocabulary
    ...
    with graph2.as_default():
        ...
        # Load the saved meta graph and restore variables
            saver2 = tf.train.import_meta_graph("model-456.meta")
        #saver = tf.train.import_meta_graph("{}.meta".format(checkpoint_file))
            saver2.restore(sess2, "model-456")
